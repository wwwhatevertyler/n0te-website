  ...
  return (
    <section className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden px-6 pb-10 pt-10">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, #111111 0%, #111111 28%, rgba(17,17,17,0.82) 50%, rgba(17,17,17,0.18) 80%, rgba(17,17,17,0.08) 100%)",
        }}
      />
      ...
      >
        ...
        >
          <motion.a
            ...
            className="flex items-center gap-2.5 bg-white text-[#0d1117] font-semibold text-[13px] px-5 py-2.5 rounded-xl hover:bg-white/90 transition-colors duration-200"
          >
