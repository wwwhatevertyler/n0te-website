          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                className="flex items-center justify-center gap-2.5 w-full bg-[var(--theme-cta-bg)] text-[var(--theme-cta-fg)] font-semibold text-[13px] py-2.5 rounded-xl transition-colors duration-200 hover:bg-[var(--theme-cta-bg-hover)]"
              >
