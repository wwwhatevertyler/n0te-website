        ...
        >
          ...
          <div>
            ...
            <motion.p
              ...
              className="mt-4 text-[16px] text-white/35 leading-relaxed"
            >
          ...
          >
            ...
            >
              <div className="flex items-end gap-2 mb-1">
                <span className="text-[52px] font-semibold font-jura text-white leading-none tracking-tight">
                  Free
                </span>
              </div>
              ...
              <motion.a
                ...
                className="flex items-center justify-center gap-2.5 w-full bg-white text-[#0d1117] font-semibold text-[14px] py-3.5 rounded-xl hover:bg-white/90 transition-colors duration-200"
              >
